...
class AgreeToApplyOrg extends StatefulWidget {
  const AgreeToApplyOrg({super.key});

  @override
  State<AgreeToApplyOrg> createState() => _AgreeToApplyOrgState();
}

class _AgreeToApplyOrgState extends State<AgreeToApplyOrg> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Thank you for your interest on applying as an organization',
