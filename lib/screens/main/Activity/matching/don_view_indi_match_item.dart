...
import 'package:donatem/screens/main/Activity/matching/don_view_indi_match_item_det.dart';
import 'package:donatem/shared/inputButton_1.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:google_fonts/google_fonts.dart';

class DonViewIndiMatchedItem extends StatefulWidget {
  const DonViewIndiMatchedItem({super.key});

  @override
  State<DonViewIndiMatchedItem> createState() => _DonViewIndiMatchedItemState();
}

class _DonViewIndiMatchedItemState extends State<DonViewIndiMatchedItem> {
  @override
  void initState() {
    super.initState();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: InputButton1(
                  onTap: () {
                    Get.to(() => const DonViewIndiMatchedItemDetails(),
