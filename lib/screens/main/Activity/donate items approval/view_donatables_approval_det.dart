...
import 'package:donatem/screens/main/Activity/donate%20items%20approval/view_donatables_approval_dismissed.dart';
...
class ViewDonatablesAprovalItemDetails extends StatefulWidget {
  const ViewDonatablesAprovalItemDetails({super.key});

  @override
  State<ViewDonatablesAprovalItemDetails> createState() =>
      _ViewDonatablesAprovalItemDetailsState();
}

class _ViewDonatablesAprovalItemDetailsState
    extends State<ViewDonatablesAprovalItemDetails> {
  // firebase uid
  ...
  Future recDismissed() async {
    ...
    {
       Get.to(() => const ViewDonatablesApprovalDismissed());
    }
  }
