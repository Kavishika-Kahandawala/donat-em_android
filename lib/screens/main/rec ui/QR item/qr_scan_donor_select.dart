...
class QrScanDonorSelect extends StatefulWidget {
  const QrScanDonorSelect({super.key});

  @override
  State<QrScanDonorSelect> createState() => _QrScanDonorSelectState();
}

class _QrScanDonorSelectState extends State<QrScanDonorSelect> {
  @override
...
class _PaginatedFirestoreListState extends State<_PaginatedFirestoreList> {
  // firebase uid
  String uid = Get.arguments[0].toString();
