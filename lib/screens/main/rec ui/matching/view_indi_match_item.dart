...
class ViewIndiMatchedItem extends StatefulWidget {
  const ViewIndiMatchedItem({super.key});

  @override
  State<ViewIndiMatchedItem> createState() => _ViewIndiMatchedItemState();
}

class _ViewIndiMatchedItemState extends State<ViewIndiMatchedItem> {
  @override
  void initState() {
    super.initState();
  }
