...
class ViewIndiMatchedItemDetails extends StatefulWidget {
  const ViewIndiMatchedItemDetails({super.key});

  @override
  State<ViewIndiMatchedItemDetails> createState() =>
      _ViewIndiMatchedItemDetailsState();
}

class _ViewIndiMatchedItemDetailsState
    extends State<ViewIndiMatchedItemDetails> {
  // firebase uid
  ...
  Future recDismissed() async {
    ...
    {
       Get.to(() => const RecMatchDismissed());
    }
  }
